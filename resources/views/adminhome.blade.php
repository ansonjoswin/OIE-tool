            ...
            @if(count($comments) > 0)
                ...
                @foreach($comments as $comment)
                    ...
                    <div class="col-md-8 col-md-offset-2 well">
                        ...
                        <!-- Comment -->
                        <a class="pull-left">
                            <img class="media-object" src=" {{ asset('images/usericon.png') }}" width='30px'
                            ...
                            @foreach($comment->replies as $reply)
                                @if($reply->is_active)
                                    <div class="media" style="padding-left: 50px;">
                                        <a class="pull-left">
                                            <img class="media-object" src=" {{ asset('images/usericon.png') }}"
                                                 width='30px' height='30px' class="img-responsive">
                                        </a>
                                        <div class="media-body">
